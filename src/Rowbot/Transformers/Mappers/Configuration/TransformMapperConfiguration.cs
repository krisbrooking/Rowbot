...
namespace Rowbot.Transformers.Mappers.Configuration;
...
public class TransformMapperConfiguration<TSource, TTarget>
{
    ...
    /// <param name="addSourceMapper">Callback to mapper configuration to add new mapper to collection</param>
    /// <param name="addTargetMapper">Callback to mapper configuration to add new mapper to collection</param>
    internal TransformMapperConfiguration(
        MapperConfiguration<TSource, TTarget> configuration, 
        Action<ISourceMapperAction<TSource, TTarget>> addSourceMapper, 
        Action<ITargetMapperAction<TTarget>> addTargetMapper)
    {
