...
namespace Rowbot.IntegrationTests.Sqlite.Tests
{
    ...
    public class SqliteSlowlyChangingDimensionTests
    {
        public SqliteSlowlyChangingDimensionTests() 
        {
            SqliteTest.Reset();
        }
        ...
        public class CustomerPipeline : IPipelineContainer
        {
            ...
            public Pipeline LoadDeletes() =>
                _pipelineBuilder
                    .ExtractSqlite<Customer>(SqliteTest.ConnectionString,
                        @"
                        SELECT
                            customer.[Id],
                            customer.[KeyHash],
        ...
        public class CustomerPipelineOverrideDeleteWithIsActiveFalse : IPipelineContainer
        {
            private readonly IPipelineBuilder _pipelineBuilder;

            public CustomerPipelineOverrideDeleteWithIsActiveFalse(IPipelineBuilder pipelineBuilder)
            {
                _pipelineBuilder = pipelineBuilder;
            }
            ...
            public Pipeline LoadDeletes() =>
                _pipelineBuilder
                    ...
                    .Transform<Customer>(
                        ...
                        mapper => new MapperConfiguration<Customer, Customer>())
                    .LoadSqlite(SqliteTest.ConnectionString)
